...
public:
    ...
    // Shader stages
    PipelineBuilder& add_compute_shader(const VkShaderModule& shader);
    PipelineBuilder& add_vertex_shader(const VkShaderModule& shader);
    PipelineBuilder& add_fragment_shader(const VkShaderModule& shader);
