...
#include <cstdint>
#include <memory>
#include <string/pipeline/pipeline_builder.hpp>
...
PipelineBuilder& PipelineBuilder::add_compute_shader(const VkShaderModule& shader)
{
    compute_shader_module_ = shader;
...
PipelineBuilder& PipelineBuilder::add_vertex_shader(const VkShaderModule& shader)
{
    vertex_shader_module_ = shader;
...
PipelineBuilder& PipelineBuilder::add_fragment_shader(const VkShaderModule& shader)
{
    fragment_shader_module_ = shader;
